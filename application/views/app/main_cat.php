...
<span class="card-title-cat text-start"><?php echo $car['name'];?> (<?php echo $car['subcat'];?>)</span>
  ...
  <div class="row g-0"> 
    ...
    <div class="col-8">
      <div class="card-body">
		...
		<p class="card-text" style="position:absolute;bottom:23px;">
          <span style="font-size:22px;font-weight:700;">₹<?php echo $bk['price'];?></span>&nbsp;&nbsp;
          <span style="font-size:17px;color:#9b9b9bc9;"><del>₹<?php echo $bk['mrp'];?></del></span>&nbsp;
